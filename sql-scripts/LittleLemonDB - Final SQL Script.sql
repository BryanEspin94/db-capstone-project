...
BEGIN
    ...
    SELECT COUNT(*), MAX(Status) INTO bookingExists, bookingStatus
    FROM Bookings
    WHERE BookingID = booking_id;

    -- If booking does not exist, return an error
    IF bookingExists = 0 THEN
...
BEGIN
    ...
    INSERT INTO Audit_Log (TableName, ActionType, RecordID, NewData, PerformedBy)
    VALUES ('Orders', 'INSERT', newOrderID, 
            CONCAT('Customer: ', p_CustomerID, ', Staff: ', p_StaffID, ', BookingID: ', p_BookingID), 
            p_PerformedBy);
